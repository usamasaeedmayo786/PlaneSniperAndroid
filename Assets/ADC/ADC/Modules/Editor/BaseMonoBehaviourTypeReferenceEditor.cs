...
{
    public class BaseMonoBehaviourTypeReferenceEditor<DatabaseType, DataType> : PropertyDrawer where DatabaseType : ADC.Core.BaseMonoBehaviourDatabase<DataType> where DataType : ADC.Core.BaseMonoBehaviourType
    {
