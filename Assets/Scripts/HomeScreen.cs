...
public class HomeScreen : MonoBehaviour
{
    ...
    private const string MaxSdkKey = "WhZJHhmeJriBhTM7k3sHp2WpZih_aJ85HuWZPIii4gxQddsfAIzDvQ_PIDTo0EJqkbPuD4OvzcMSRw6tgc9vEI";
...
#else // UNITY_ANDROID
    private const string InterstitialAdUnitId = "80b2f312757052a3";
    private const string RewardedAdUnitId = "9beac2dda9fb4955";
    private const string BannerAdUnitId = "47985975778cbd09";
    private const string MRecAdUnitId = "xxxxxxxxxxxxxx";
#endif
